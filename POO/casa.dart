void main() {
  ...
  Casa c3 =
      Casa.comPiscinaEChurrasqueira(100.8, qtdQuartos: 6, qtdBanheiros: 4);
  print(c3.tamanho);
  print(c3.piscina);
...
class Casa {
  ...
  Casa(this.tamanho, {required this.qtdQuartos, required this.qtdBanheiros});

  Casa.semPiscina(this.tamanho,
      {required this.qtdQuartos, required this.qtdBanheiros}) {
    piscina = false;
  }
